...
<body>
	...
	<div id="content">
		<h2 class="user_font">修改密碼</h2>

		<form action="<c:url value="/memorycover.action" />" method="post" onsubmit="return checksubmit();">
			<label class="user_font"><b>目前使用者:</b></label> <input id="user" type="text"
				name="email" value="${email}" readonly="readonly" style="background-color: white;" />
			<div class="container">
				<label class="user_font" for="pwd"><b>請輸入密碼</b></label> <input type="password"
				...
				<span id="strong" style="display:none"></span><br><br>
					...
					<label class="user_font" for="repwd"><b>請再次輸入密碼</b></label> <input
				...
				<button type="submit" class="btn btn-primary"
					style="width: 50%; margin-left: 180px">完成修改</button>
